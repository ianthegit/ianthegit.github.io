...
function setupBaseScreen(){
 ...
 document.write("(WARNING - these calculations DO NOT take any income tax due on income into account) <input type='button' value='Copy URL to Clipboard' title='Copy URL to Clipboard' id='C2C' onclick='createURLAndCopyToClipboard()' /> </BR> " +
