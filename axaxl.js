...
addQuest(quests[questIndexBuilder],{	type : quizQuestionTypeText, 	
	...
	answerList: "Once the details are known we could look to discuss the current situation.|"+
		"I would expect to protect the team from having to be reactionary to the loudest shouters|"+
		"I would like to engage with the team to see if there are any quick wins."});
addQuest(quests[questIndexBuilder],{	type : quizQuestionTypeText, 	
	...
	answerList: "Introduce an Agile model of working to provide better feedback to the business - not only for expectations, but also on issues and blockers|"+
	"Ensure change timeframes are fully understood by all stakeholders|"+
	"Ensure the effects of changes to priorities are well understood and communicated using well planned sprints|"+
	"Look to create dedicated SME teams with expert Tech Leads to expediate change in their areas and retain responsibility end-to-end"	});
...
addQuest(quests[questIndexBuilder],{	type : quizQuestionTypeText, 	
	...
	answerList: "Ask for a list of most performed activities to see how these could be changed to be handled quicker.|"+
			"Form SME hit-teams skilled in subsets of the system to expedite resolution.|"+
			"Ask the team what is holding them back"});
addQuest(quests[questIndexBuilder],{	type : quizQuestionTypeText, 	
	...
	answer : "Describe any steps you would take to streamline the process, re-organise the team, motivate them and increase throughput</BR></BR>Short Term"	, answerSpeak : "",
	answerList: "Look to form Tech Leads from AD and Lvl3 top performers to manage small focused SME teams|"+
			"Ensure effective KT is being given by AD to Lvl 3|"+
			"Give teams their own areas and allow them to become SME teams with expert Tech Leads|"+
			"Remove barriers between AD and Lvl3 and create end-to-end teams who can take reponsibility"});
addQuest(quests[questIndexBuilder],{	type : quizQuestionTypeText, 	
	...
	answerList: "Look at why there are so many Lvl 2 and 3 items|"+
			"What can be done to make AD more responsible for issue resolution - Merge AD and Lvl3 teams into smaller independent SME teams with experienced Tech Leads who can work to improve their velocity|"+
			//"Throttle demand where possible to allow the teams to coalesce|"+
			"Introduce Agile - daily ceremonies can highlight progress made and provide positive feedback where traditional methodologies lack this|" +
			"Agile sprints and a backlog will help remove the feelng of being ovewhelmed as the Scrummaster can control sprint content"});
...
addQuest(quests[questIndexBuilder],{	type : quizQuestionTypeText, 	
	...
	answerList: "Fullfillment might not be done in the most agile or appropriate methodology|"+
			"Could hit-teams of SMEs be created to take on certain areas|"+
			"Look to merge AD and Lvl3 to ensure end-to-end responsibility and drive team desire for less defects"});
addQuest(quests[questIndexBuilder],{	type : quizQuestionTypeText, 	
	...
	answerList: "Are all requests expected to be fullfilled quickly or can there be 2 (or more) fullfillment lists created|"+
			"Ensure timeframes remain relevant for teams' abilities and experience - make sure team velocity is known|"+
			"Keep teams away from escalations and business pressure - engage a scrummaster to manage workloads into sprints"});
addQuest(quests[questIndexBuilder],{	type : quizQuestionTypeText, 	
	...
	answerList: "Ensure we have a team appropriate - both technical and size appropriate - to deal with the volumes|"+
			"Use Agile delivery methods to ensure teams are not exposed to large lists of defects which can be disheartening - create a backlog and concentrate on a sprint|"+
			"Merge AD and Lvl3 teams into smaller independent SME teams with experienced Tech Leads who can work to improve their velocity"});
